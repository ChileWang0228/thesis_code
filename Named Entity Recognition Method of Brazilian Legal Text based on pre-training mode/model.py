...
class Model:
    ...
    def __init__(self, config):
        ...
        self.embed_dense_dim = config.embed_dense_dim
        ...
        if self.model_type == 'bilstm':
            ...
            lstm_outputs = self.biLSTM_layer(lstm_inputs, self.lstm_dim, self.lengths)  # lstm_dim = 100
            # lstm_outputs = self.biLSTM_layer(lstm_outputs, config.lstm_dim, self.lengths)
    ...
    def IDCNN_layer(self, model_inputs, name=None):
        ...
        # reuse = tf.cond(self.is_training, lambda: True, lambda: False)
